...
//REPLACE
#define TARGET_CLASS "com/example/module/AESCryptor"
...
//AES_KEY
static unsigned char AES_KEY[32] = {0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01,
...
JNICALL android_native_aes(JNIEnv *env, jclass clazz,
...
JNICALL android_native_read(JNIEnv *env, jclass clazz,
